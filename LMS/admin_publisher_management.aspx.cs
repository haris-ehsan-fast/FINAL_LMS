...
namespace LMS
{
    public partial class WebForm10 : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (pname == string.Empty)
                {
                    ...
                    buttonerror.Text = "*Publisher Name cannot be empty";
                }
                else
                {
                    int output = objMyDal.addPublisher(pid, pname);
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            int output = objMyDal.delPublisher(pid);
            try
            {
                if (output == 0)
                {
                    buttonerror.Visible = true;
                    buttonerror.ForeColor = System.Drawing.Color.IndianRed;
                    buttonerror.Text = "*Invalid Publisher ID";
                }
                else if (output == 1)
                {
                    buttonerror.Visible = true;
                    buttonerror.ForeColor = System.Drawing.Color.IndianRed;
                    buttonerror.Text = "*Publisher cannot be deleted";
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                {
                    int output = objMyDal.upPublisher(pid, pname);
                    ...
                    else if (output == 1)
                    {
                        buttonerror.Visible = true;
                        buttonerror.ForeColor = System.Drawing.Color.IndianRed;
                        buttonerror.Text = "*Publisher cannot be updated";
                    }
                    else
                    {
                        buttonerror.Visible = true;
